          ...
          <div>
            <a href="#home" className="flex items-center gap-3 mb-5 group" aria-label="Rodricks Analytics — back to top">
              <img
                ...
                loading="lazy"
                decoding="async"
                className="h-12 w-12 object-cover rounded-full shrink-0 shadow-[0_0_0_2px_hsl(var(--primary)/0.24),0_0_12px_hsl(var(--primary)/0.18)] transition-transform duration-300 group-hover:scale-[2]"
              />
